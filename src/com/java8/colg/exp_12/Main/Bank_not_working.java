...
public class Bank_not_working extends Applet implements ActionListener {
    Label title, name,aadharcard, mobileno,gender,address,email,maritalstatus, nationality,account,status;
